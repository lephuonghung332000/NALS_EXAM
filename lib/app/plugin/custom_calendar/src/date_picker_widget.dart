...
class _DatePickerState extends State<DatePicker> {
  ...
  void initState() {
    ...
    if (widget.datePickerController != null) {
      widget.datePickerController!.setDatePickerState(this);
      _controller = ScrollController(initialScrollOffset: 7*(widget.width));
    }
...
class DatePickerController {
  ...
  void jumpToSelection() {
    ...
    if ( _datePickerState!._controller.hasClients) {
